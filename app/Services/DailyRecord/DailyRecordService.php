...
class DailyRecordService implements DailyRecordServiceInterface
{
    ...
    public function updateByUser(Model $user,Model $dailyRecord) : Model
    {

        $data['male_count']     = $this->userService->getCountByGender()['male_count'];
        $data['female_count']   = $this->userService->getCountByGender()['female_count'];
